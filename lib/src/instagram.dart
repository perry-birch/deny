...
import '../../../../wearshare/WearShareDart/packages/http/http.dart' as http;
import '../../../../wearshare/WearShareDart/packages/oauth2/oauth2.dart' as OAuth;
...
class InstagramOAuth2 {
  ...
  final OAuth.AuthorizationCodeGrant _authCodeGrant;

  const InstagramOAuth2._(
      this._identifier,
      this._secret,
  ...
  static final dynamic from = (
    ...
    var grant = new OAuth.AuthorizationCodeGrant(
        identifier,
        secret,
        authorizationEndpoint,
        tokenEndpoint);
    return new InstagramOAuth2._(
        identifier,
        secret,
        authorizationEndpoint,
        tokenEndpoint,
  ...
  static final dynamic wearShareDev = () {
    return from(
        '0e5f7cac671d40c5b528638e94578686',
        '9eab6075604049b896a87b299f16adc1',
        new Uri('https://api.instagram.com/oauth/authorize/'),
        new Uri('https://api.instagram.com/oauth/access_token'),
        new Uri('http://wearsharedart.heroku.com/oauth'),
        ['basic', 'comments']
        );
  };

  static final dynamic wearShareLocalDev = () {
    return from(
        'c023236eb60d460b90e5867889f186be',
        '9a4a1f8462224f228234b023adbb5115',
        new Uri('https://api.instagram.com/oauth/authorize/'),
        new Uri('https://api.instagram.com/oauth/access_token'),
        new Uri('http://localhost:8080/oauth'),
        ['basic', 'comments']
        );
  };
  ...
  Future<OAuth.Credentials> handleResponse(HttpRequest request) {
  ...
  void _checkForResponseError(Map<String, String> params) {
    ...
    throw new Exception(parameters['error'], description, uri);
  }
